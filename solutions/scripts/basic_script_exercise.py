...
def process_fasta_file(fasta_file: str, output_dir: str, is_template_strand: bool = True, compute_stats: bool = False):
    """
    ...
    dna_sequences = read_dna_fasta_file(fasta_file)
...
def run_overall_pipeline(sequence_folder: str, output_folder: str, compute_stats: bool = True):
    """
    ...
    for fasta_file in files_to_consider:
        ...
        process_fasta_file(fasta_file=full_input_path, output_dir=output_folder, compute_stats=compute_stats, is_template_strand=is_template_strand)


if __name__ == "__main__":
    run_overall_pipeline(sequence_folder="code/sequences", output_folder="solutions/protein_sequences/", compute_stats=True)
